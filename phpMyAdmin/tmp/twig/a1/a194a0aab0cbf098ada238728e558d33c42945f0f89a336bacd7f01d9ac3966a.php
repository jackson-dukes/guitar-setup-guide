...
echo _gettext("Continue");
    ...
    {
        return new Source("", "database/structure/bulk_action_modal.twig", "/var/www/guitarsetup.info/public_html/phpMyAdmin/templates/database/structure/bulk_action_modal.twig");
    }
}
